...
def gen_coreml(space, mode='cpu_only'):
    for s in space:
        ...
        model = BaseRWKV_HIRA_MOA_MOE(args, attn_blk_cls=AttnBlk_VMoA, use_mlp_moe=False)
        ...
        with torch.no_grad():
            ...
            save_dir = f'/home/zhaoy/OmniComp-MoA-MoE-cvpr2026/coreml/mlpackage/{mode}/rwkv7-hira-vmoa/rwkv7-hira-vmoa-{size}'
