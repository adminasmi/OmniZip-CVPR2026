...
from cuda import HEAD_SIZE, RUN_CUDA_RWKV7g
from moa import ReceptanceExpert, ValueExpert, KeyExpert
from moe import MoE
    ...
    def forward(self, x, v1):
        ...
        for name in ['receptance', 'key', 'value']:
            ...
            if name in self.shared:
                ...
                outputs[name], aux_losses[name] = getattr(self, f'moa_{name}')(xin, mode=mode)
