...
@MODULE_BUILD_FUNCS.register_with_name(module_name='rwkv7_hira_vmoa_moe')
def build_rwkv7_hira(args):
    from attnmoablks import AttnBlk_VMoA
    model = BaseRWKV_HIRA_MOA_MOE(args, attn_blk_cls=AttnBlk_VMoA, use_mlp_moe=True)
...
if __name__ == '__main__':
    ...
    from models.common import test_speed, cal_macs
    test_speed(model, args.vocab_size, batch_sizes=[1,16,128,512,1024], seq_len=16)
    cal_macs(model, args.vocab_size, batch_size=1, seq_len=16)
