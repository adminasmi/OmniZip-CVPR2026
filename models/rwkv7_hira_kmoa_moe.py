...
@MODULE_BUILD_FUNCS.register_with_name(module_name='rwkv7_hira_kmoa_moe')
def build_rwkv7_hira(args):
    from attnmoablks import AttnBlk_KMoA
    model = BaseRWKV_HIRA_MOA_MOE(args, attn_blk_cls=AttnBlk_KMoA, use_mlp_moe=True)
