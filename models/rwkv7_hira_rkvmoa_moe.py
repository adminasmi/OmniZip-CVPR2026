...
@MODULE_BUILD_FUNCS.register_with_name(module_name='rwkv7_hira_rkvmoa_moe')
def build_rwkv7_hira(args):
    from attnmoablks import AttnBlk_RKVMoA
    model = BaseRWKV_HIRA_MOA_MOE(args, attn_blk_cls=AttnBlk_RKVMoA, use_mlp_moe=True)
